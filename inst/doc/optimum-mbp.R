...
## ---- load some data from the package, echo=TRUE------------------------------
fish <- telemetR::fish
receivers <- telemetR::receivers
detects <- telemetR::filtered_detections

## ---- format the data to make it easier to use the package, echo = TRUE-------
...
## ---- Begin the blanking period analysis, echo = TRUE-------------------------
...
## ---- Compare the results of the blanking analysis to a set of times, echo = TRUE----
...
## ----plot the proportion of events with durations greater than t, echo = TRUE----
...
## ----next calculate the renormalized sum of squares, echo = TRUE--------------
...
## ----next calculate the convergence thresholds, echo = TRUE-------------------
...
## ----finally determine optimum mbps and plot rSSR results, echo = TRUE--------
